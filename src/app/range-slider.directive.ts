...
export class RangeSliderDirective implements OnInit {
  ...
  @Input("relevantValues") relevantValues: any;
  @Input("oldSelectionValues") oldSelectionValues: any;
  ...
  ngOnInit() {
    ...
    this.renderer.listen(range_left, "input", (event):any => {
    ...
    this.renderer.listen(range_right, "input", (event): any => {
      console.log("RANGE RIIGHT");
      old_range.style.opacity = 0;
